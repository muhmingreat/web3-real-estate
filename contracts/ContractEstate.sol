...
contract ContractEstate {
    ...
    event PropertySold(uint256 indexed id, address indexed oldOwner, address indexed newOwner,
                        uint256 price);
    event PropertyResold(uint256 indexed id, address indexed oldOwner, address indexed newOwner,
                         uint256 price);
    ...
    event ReviewAdded(uint256 indexed productId,
     address indexed reviewer, uint256 rating, string comment);

    event  ReviewLiked(uint256 indexed productId,
    uint256 indexed reviewIndex, address indexed liker,uint256 likes);


    //   FUNCTION IN CONTRACT
    function listProperty(address owner, uint256 price, string memory _propertyTitle,
    string memory _category, string memory _images, string memory
    ...
    function updateProperty(address owner, uint256 productId,
    string memory _images, string memory _propertyAddress, 
    string memory _propertyTitle, string memory _category,
    ...
    function buyProperty(uint256 id, address buyer) external payable {
     ...
     require(amount >= properties[id].price,"Insuficent funds");
...
function addRewiew(uint256 productId, uint256 rating,
string calldata comment, address user) external {
...
function getProductRewiew(uint256 productId) external view returns(Review[] memory) {
...
function likeReview(uint256 productId, uint256 reviewIndex, 
...
function getHigtestRatedProduct()external view returns(uint256){
